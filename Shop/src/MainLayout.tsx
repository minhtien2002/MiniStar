                ...
                >
                  ...
                  <ul>
                    <li className="absolute">
                      {" "}
                      <img
                        className="hidden bg-white  shadow-xl rounded-lg p-5 group-hover:flex"
                        src="https://quomodosoft.com/html/ecoshop/assets/images/homepage-one/empty-wishlist.webp"
                        alt=""
                      />
                    </li>
                  </ul>
