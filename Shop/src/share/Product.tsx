...
const Product: React.FC<ProductProps> = ({ ProductId, ProductName, Price, ProductImage }) => {
  return (
    <div className={"flex flex-col justify-center items-center border border-white my-8 p-6 rounded-md shadow-lg cursor-pointer hover:border-solid hover:border hover:border-[#34A853]"}>
      <div className="mt-2 mb-4">
        <img src={ProductImage} alt={ProductName} className='group-[.border-solid]:scale-125' />
      </div>
