...
const API_ENDPOINTS = {
  ...
  getAddresses: (userId:number) => `${API_BASE_URL}/address/user/${userId}`,
  addAddress: (userId:number) => `${API_BASE_URL}/address/user/${userId}`,
  deleteAddress: (addressId:number) => `${API_BASE_URL}/address/${addressId}`,
  deleteOrder: (orderId:number) => `${API_BASE_URL}/order/${orderId}`,
  deleteUser: (userId:number) => `${API_BASE_URL}/User/${userId}`,
