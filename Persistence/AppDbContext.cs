    ...
    public class AppDbContext : DbContext
    {
       ...
       .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { ProductId = 6, ProductName = "Tết rôm rả", Description = "null", Price = 40, Quantity = 30, ProductImage = "banhgaotet.png", CreateAt = DateTime.Now, UpdateAt = DateTime.Now, IsDeleted = false, BrandId = 5, CategoryId = 6 },
